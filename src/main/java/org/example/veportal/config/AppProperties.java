...
public record AppProperties(Cors cors, Jwt jwt, Mail mail, Storage storage,
                            Security security, boolean seedDemoData) {
    ...
    public record Security(boolean allowTemporaryPasswordDisplay) {
    }
